...
Optionally, you may create `config.json` within this folder to suppress noisy transitions within certain model families.  For example:
...
For npm installation and package-specific docs, see [`packages/pi-assistant-provenance/`](../../packages/pi-assistant-provenance/).
